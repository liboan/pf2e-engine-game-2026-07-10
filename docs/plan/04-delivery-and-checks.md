...
**W2 is accepted; W3 is authorized now.** Reuse the team and checkouts for a substantially larger coherent wave. The existing heartbeat is the fallback while W3 is active. After acceptance the coordinator must commit and push accepted W2/W3 history and guidance to an appropriate codex/ delivery branch, verify both waves in ancestry and the exact remote head, and report any applicable PR. No force-push, main merge or overwrite; no new PR requirement.
