Historical snapshot immediately before W5 acceptance and closure. Current status: [ACTIVE](../ACTIVE.md).
...
W4 delivered eleven new feats; Widen remains W3-existing and Dangerous Sorcery deferred. Independent final repaired assembly accepted, canonical1,496 tests/7.53s, runner7.867s, peak88,342,528 bytes, compile/diff/test0, accepted117/94 staged24/12 save18. [Acceptance evidence](content-w4-accepted.md); prior W4 IDs/models/checkouts preserved in [coordination archive](content-w4-coordination.md). W4 tasks are closed for milestone purposes and will not be carried/forked into W5.
