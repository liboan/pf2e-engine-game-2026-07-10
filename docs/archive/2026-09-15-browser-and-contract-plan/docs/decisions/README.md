...
| --- | --- | --- | --- | --- |
| [0001](0001-initial-product-and-rules-boundary.md) | Initial product and rules boundary | `resolved` | Integrated at `fa8e89d`; pending stable approver ID | [Charter](../design/00-product-charter.md), [rules/content](../design/01-rules-and-content.md) |
| [0002](0002-foundational-rules-contracts.md) | Foundational semantic/execution contracts and walking-skeleton boundaries | `resolved` | Integrated at `87bd81f`; pending stable approver ID | [Status](../../STATUS.md), [rules/content](../design/01-rules-and-content.md), [engine](../design/02-engine-and-interfaces.md), [roadmap](../design/07-roadmap.md) |
