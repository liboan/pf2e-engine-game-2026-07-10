...
def build_w5_focus_content(warpriest: CreatureDefinition):
    ranger = replace(
        ...
        abilities=(*RANGER_PRECISION.abilities, "gravity_weapon"),
        ...
        sheet_notes=(*RANGER_PRECISION.sheet_notes,
    ...
    cleric = replace(
        ...
        feats=("Natural Ambition", "Assurance (Athletics)", "Harming Hands"),
        skills=tuple(("arcana", "trained", 7) if skill == "religion" else skill for skill in warpriest.skills if skill[0] not in {"crafting", "society", "religion"}) + (("arcana", "trained", 7),),
        held_items=(),
        ...
        sheet_notes=(*warpriest.sheet_notes,
            ...
            "Natural Ambition replaces Natural Skill; Crafting and Society are not retained. Nethys's deity skill is Arcana. No longsword or staff is granted; Deadly Simplicity is recorded but not expanded.",
